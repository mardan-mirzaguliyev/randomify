export const SAMPLE_BLOG_POSTS = [
  {
    ...
    excerpt:
      'A curated list of the must-watch films from this year, ranging from indie darlings to blockbuster hits.',
    category: 'Films',
  ...
  },
  {
    ...
    excerpt:
      'Discover the best books to read this summer, from gripping thrillers to thought-provoking non-fiction.',
    category: 'Books',
    date: 'June 20, 2024',
    readTime: '4 min read',
    image: '📚',
  ...
  },
  {
    ...
    excerpt:
      'How embracing randomness can lead to better decision-making and more exciting discoveries in everyday life.',
    category: 'Lifestyle',
    date: 'March 10, 2024',
    readTime: '6 min read',
    image: '🎲',
  ...
  },
  {
    ...
    content: `
      ...
      <h2>These films may not have had massive marketing campaigns, but they offer unique cinematic experiences that reward attentive viewers.</h2>
    `,
  },
  {
    id: '5',
    ...
    excerpt:
      'Tips and strategies for creating and maintaining a reading list that actually works for you.',
    category: 'Books',
...
export const SAMPLE_BLOG_POST_MAP = SAMPLE_BLOG_POSTS.reduce((postsById, post) => {
